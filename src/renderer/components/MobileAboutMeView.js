...
const AboutPreview = (props) => {
  ...
  const defaultAboutMeDesc = 'This is just some filler lorem ipsum, no not really, but this is an about page that should be something about you! Now make up your mind and say something about yourself! Probably something good and not bad! Yeah! '
    ...
    <Container style={styles.flex}>
      ...
      <div style={styles.textBorder}>
        <p style={styles.aboutMeHeader}>
          {/*AboutMeHeader*/} {appDetails.AboutMeTitleText|| 'Title Text'} {/*AboutMeHeader*/}
        </p>
        <p style={styles.text}>
          {/*AboutMeDescText*/}{appDetails.AboutMeDescText || defaultAboutMeDesc}{/*AboutMeDescText*/}
        </p>
      <Button
        // onPress={() => this.props.navigation.navigate('Contact')}
        content= /*AboutMeButtonText*/ {appDetails.AboutMeButtonText||'Contact'} /*AboutMeButtonText*/
        inverted
